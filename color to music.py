...
print('start')
with open('Edvard-Munch-The-Scream.txt') as f:
    color = f.read().splitlines()

with open('etc/color_combos.txt') as f:
...
with open('etc/color_combos_dict.txt') as f:
...
colors_by_notes = []
with open('etc/color_chart_rgb.csv') as file:
...
midi_stream.write('midi', fp='Edvard-Munch-The-Scream.mid')
print('done')
